  ...
  return (
    <header className="overflow-hidden rounded-[28px] border border-[#ded7e3] bg-white shadow-[0_18px_50px_rgba(70,48,96,0.08)]">
      <div className="relative px-5 py-7 sm:px-8 sm:py-9">
        <div className="knowledge-hero-decoration pointer-events-none absolute -right-14 -top-20 size-56 rounded-full border-[28px]" />
        <div className="relative flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            <span className="knowledge-icon-tile flex size-11 items-center justify-center rounded-2xl shadow-sm">
              <BookOpen className="size-5" />
            </span>
            <p className="knowledge-accent-text mt-5 text-xs font-bold uppercase tracking-[0.18em]">Project intelligence</p>
          ...
          <div className="knowledge-soft-panel w-full rounded-2xl border border-[#e4dcea] p-4 lg:w-[300px]">
